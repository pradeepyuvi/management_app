    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          /// ⭐ FEATURES – EXACTLY 4 PER ROW ⭐
          LayoutBuilder(
            builder: (context, constraints) {
              // total width inside card
              final double maxWidth = constraints.maxWidth;

              // spacing between items
              final double spacing = 3.w;

              // width for each of the 4 columns
              final double itemWidth =
                  (maxWidth - (3 * spacing)) / 4; // 4 items, 3 gaps
              ...
              return Wrap(
                ...
                children: featureList
                    .map(
                      (f) => SizedBox(
                        width: itemWidth,
                        child: FeatureIconText(icon: _getIcon(f), text: f),
                      ),
                    )
                    .toList(),
              );
